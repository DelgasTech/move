...
const WA_LINK = "https://wa.me/5511978246761?text=Olá! Quero saber mais sobre o Moutonnée Move.";

const navLinks = [
  { label: "Modalidades", href: "#modalidades" },
  { label: "Planos", href: "#planos" },
  { label: "Move Academia", href: "/" },
];

export default function MoutonneeHeader() {
